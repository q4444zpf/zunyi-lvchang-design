...
const store=usePlantStore(); const pending=ref<DispatchRequest|null>(null); const dialogOpen=ref(false); const toast=ref("");
...
<template>
  <div class="app-shell">
    ...
    <main>
      ...
      <div v-if="store.loading" class="loading-state"><span></span>正在连接实时数据</div>
